...
var getUserToken = function (_id) {
    var token = jsonwebtoken_1.default.sign({ _id: _id }, "express", {
        expiresIn: "7d",
    });
    return token;
};
...
var loginUser = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, isPasswordIdentical, _b, _c, _d, token, error_2;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                _a = _e.sent(), email = _a.email, password = _a.password;
                return [4 /*yield*/, user_model_1.default.findOne({ email: email })];
            case 2:
                existingUser = _e.sent();
                if (!existingUser) {
                    return [2 /*return*/, response.status(409).send("User not found")];
                }
                _c = (_b = bcrypt_1.default).compare;
                _d = [password];
                return [4 /*yield*/, existingUser];
            case 3: return [4 /*yield*/, _c.apply(_b, _d.concat([(_e.sent()).password]))];
            case 4:
                isPasswordIdentical = _e.sent();
                if (isPasswordIdentical) {
                    ...
                    return [2 /*return*/, response.status(409).send("Password is incorrect")];
                }
                return [3 /*break*/, 6];
            case 5:
                error_2 = _e.sent();
